    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="ledger-shell flex flex-1 flex-col gap-4 xl:flex-row xl:overflow-hidden">
        ...
        <main className="flex-1 flex flex-col xl:flex-row overflow-visible xl:overflow-hidden">
          <div className="order-2 xl:order-1 w-full xl:w-72 xl:flex-shrink-0 p-4 ledger-panel">
            <CouncilReports />
          </div>

          <div className="order-1 xl:order-2 flex-1 p-4 ledger-panel ledger-panel--raised">
            <ActiveReport />
          </div>
        </main>
